...
import com.yd.mofanghuanyuans.main.adapter.MfgsAdapter;
...
public class MofanggsActivity extends BasePresenterActivity {


    @BindView(R.id.recycgs)
    RecyclerView recycgs;
    private ArrayList<MofangBean.ListDTO> mListDTOS;
    private MfgsAdapter mMfgsAdapter;
    private List<MofangBean.ListDTO> list;
    private int level;
    private int ifPay;
    @Override
    protected int getLayoutId() {
        return R.layout.activity_mf_gongshi;
    }
...
//                }
    ...
    public static void start(Context context) {
        Intent intent = new Intent(context, MofanggsActivity.class);
    ...
    public void gsrefit(){
        ...
        recycgs.setLayoutManager(layoutManager);
        mListDTOS = new ArrayList<>();
        mMfgsAdapter = new MfgsAdapter(mListDTOS, this);
        recycgs.setAdapter(mMfgsAdapter);
...
//                .addCallAdapterFactory(RxJava2CallAdapterFactory.create())
        ...
        mofangBeanCall.enqueue(new Callback<MofangBean>() {
            ...
            public void onResponse(Call<MofangBean> call, Response<MofangBean> response) {
                ...
                if(list !=null){
                    ...
                    mMfgsAdapter.notifyDataSetChanged();
                }
        ...
        mMfgsAdapter.setJiekouhuidiaos(new MfgsAdapter.Jiekouhuidiao() {
            @Override
            public void OnClike(int position) {
                if (ifPay==0){
                    String content = list.get(position).getContent();
                    Intent intent = new Intent(MofanggsActivity.this, WebActivity.class);
                    ...
                    if (level == 0) {
                        if (position == 0) {
                            ...
                            Intent intent = new Intent(MofanggsActivity.this, MembershipcenterActivity.class);
                            startActivity(intent);
                        }
                    } else {
