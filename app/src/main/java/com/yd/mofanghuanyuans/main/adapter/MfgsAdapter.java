...
public class MfgsAdapter extends RecyclerView.Adapter {
    private ArrayList<MofangBean.ListDTO> list;
    private Context context;

    public MfgsAdapter(ArrayList<MofangBean.ListDTO> list, Context context) {
        this.list = list;
   ...
   Jiekouhuidiao jiekouhuidiao;
    public void setJiekouhuidiaos(MfgsAdapter.Jiekouhuidiao jiekouhuidiao) {
