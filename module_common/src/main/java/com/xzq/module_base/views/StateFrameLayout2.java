...
public class StateFrameLayout2 extends FrameLayout {
    ...
    public StateFrameLayout2(Context context) {
        super(context);
        initView(context, null);
    }

    public StateFrameLayout2(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    @TargetApi(21)
    public StateFrameLayout2(Context context, AttributeSet attrs, int defStyleAttr,
                             int defStyleRes) {
    ...
    private static class SavedState extends BaseSavedState {
        ...
        public static final Creator<SavedState> CREATOR = new Creator<StateFrameLayout2.SavedState>() {
            public StateFrameLayout2.SavedState createFromParcel(Parcel in) {
                return new StateFrameLayout2.SavedState(in);
            }

            public StateFrameLayout2.SavedState[] newArray(int size) {
                return new StateFrameLayout2.SavedState[size];
            }
        };
    }
    ...
    public interface OnAllStateClickListener extends OnStateClickListener {
        void onNormalClick(StateFrameLayout2 layout);

        void onLoadingClick(StateFrameLayout2 layout);

        void onEmptyClick(StateFrameLayout2 layout);
    }
    ...
    public interface OnStateClickListener {
        void onErrorClick(StateFrameLayout2 layout);
    }
