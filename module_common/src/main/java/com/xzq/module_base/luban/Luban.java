package com.xzq.module_base.luban;
...
public class Luban implements Handler.Callback {
    ...
    private Luban(Builder builder) {
        ...
        this.mFocusAlpha = builder.focusAlpha;
        this.mQuality = builder.quality;
        this.mCompressionPredicate = builder.mCompressionPredicate;
        mHandler = new Handler(Looper.getMainLooper(), this);
        LogUtils.debug(TAG, builder.toString());
    }
    ...
    private File get(InputStreamProvider input, Context context) throws IOException {
        return new Engine(input, getImageCacheFile(context, Checker.SINGLE.extSuffix(input)), mFocusAlpha, mQuality).compress();
    }
    ...
    private File compress(Context context, InputStreamProvider path) throws IOException {
        ...
        if (mCompressionPredicate != null) {
            if (mCompressionPredicate.apply(path.getPath())
                ...
                result = new Engine(path, outFile, mFocusAlpha, mQuality).compress();
            } else {
                result = new File(path.getPath());
            }
        } else {
            result = Checker.SINGLE.needCompress(mLeastCompressSize, path.getPath()) ?
                    new Engine(path, outFile, mFocusAlpha, mQuality).compress() :
    ...
    public static class Builder {
        ...
        /**
         * The quality of method Bitmap.compress
         *
        ...
        public String toString() {
            return "Builder{" +
                    ...
                    ", quality=" + quality +
                    ", mLeastCompressSize=" + mLeastCompressSize +
                    ", mRenameListener=" + mRenameListener +
                    ", mCompressListener=" + mCompressListener +
                    ", mCompressionPredicate=" + mCompressionPredicate +
                    ", mStreamProviders=" + mStreamProviders +
                    '}';
        }
    }
}