...
public class ShaderUtil {
    ...
    private static String aPositionName;
    private static String aColorName;

    public static void setaPositionName(String aPositionName) {
        ShaderUtil.aPositionName = aPositionName;
    }

    public static void setaColorName(String aColorName) {
        ShaderUtil.aColorName = aColorName;
    }
...
/*           GLES20.glBindAttribLocation(program, 0, aPositionName);
            GLES20.glBindAttribLocation(program, 1, aColorName);*/
            //6. 链接程序
